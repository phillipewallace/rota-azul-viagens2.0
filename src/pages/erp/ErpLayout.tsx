...
import {
  ...
  ExternalLink, AlertTriangle, ArrowLeft, Sparkles, DollarSign, FileSignature, LogOut, Files, FolderOpen, FileSpreadsheet,
} from 'lucide-react';
...
const navItems = [
  ...
  { to: '/erp/excel', label: 'Excel', icon: FileSpreadsheet },
